...
SELECT users_license.ID,users.users_email, license.license_name,license.license_supplier,license.license_serialNumber, license.license_endDate, users_license.status
FROM users_license
